	...
	public function printTxdotWork(){
		...
		if($combine){
			foreach($combine as $com){
				...
				//var_dump($whereSch);
				$resSchedule = $this->schedule_model->lists( $this->txdot_print_sch ,  $whereSch,  $like = '', $json = true, $orderby = ['schedule.schedule_date'=>'desc','contract.contract_id'=>'desc', 'task.hwy_id'=>'asc', 'task_cat.tcat_id'=>'asc'], 1, 500);
